    ...
    <div className="wrap">
      ...
      {!values ? (
        ...
        <>
          ...
          {cfg.intelEndpoint && (
            <InstitutionalPanel endpoint={cfg.intelEndpoint} />
          )}

          {cfg.strategyEndpoint && (
            <StrategyPanel endpoint={cfg.strategyEndpoint} instrument={cfg.brainId} />
          )}
          ...
          <div className="footer">
            ...
            three time horizons, refreshed every 60 seconds.
          </div>
        </>
      )}
